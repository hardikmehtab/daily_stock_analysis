...
2. Support console + file (regular/debug) three-layer log output
3. Automatically reduce log level for third-party libraries
"""
...
class RelativePathFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        try:
            ...
            # If unable to convert to relative path, keep original
            pass
        return super().format(record)


# Default third-party libraries that need reduced log level
...
def setup_logging(
    ...
    Configures three-layer log output:
    ...
    Args:
        ...
        extra_quiet_loggers: Additional third-party libraries list to reduce log level
    """
    ...
    root_logger.setLevel(logging.DEBUG)  # Root logger set to DEBUG, handlers control output level
